            ...
            @foreach($banners as $cat)
                ...
                <li data-transition="fade" data-slotamount="7" data-masterspeed="500" data-thumb="" data-saveperformance="on" data-title="Intro Slide">
                    @foreach($cat->images as $image)
                        <!-- MAIN IMAGE -->
                        <img src="{{ $image->url }}" alt="" data-bgposition="center top" data-bgfit="cover" data-bgrepeat="no-repeat">
                        @break
                    @endforeach
                    <!-- LAYERS -->
